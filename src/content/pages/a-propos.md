...
Mythoskolis repose sur une idée simple : transmettre le goût des mythes en combinant rigueur, lisibilité et imaginaire. Les contenus sont conçus pour éclairer sans alourdir, pour donner envie d’explorer plus loin plutôt que d’imposer une lecture unique.

Chaque fiche, chaque ressource et chaque représentation cherche à offrir un point d’entrée compréhensible, fidèle aux sources principales, tout en étant consciente de la variété des versions et des traditions.

---

## Un projet personnel
Mythoskolis est créé et développé par une seule personne. La rédaction, la structure, l’ergonomie, les pages, les animations, le modèle généalogique : tout est conçu à la main, sur temps libre, avec passion.
...
Les illustrations présentes dans la version actuelle du site sont réalisées par l’auteur à l’aide d’outils d’intelligence artificielle : ChatGPT pour les images fixes et Grok pour les animations. Il ne s’agit pas d’un travail d’illustration au sens traditionnel, mais d’un travail de conception, de sélection, d’ajustement et de cohérence visuelle.
...
## Transparence
Lorsqu’une image fait appel à une technique particulière, l’information est indiquée lorsque cela est pertinent. Lorsqu’un style, une esthétique ou une influence notable apparaît, elle est mentionnée.
...
Cette ouverture se fera dans un cadre clair, cohérent et transparent. Elle permettra d’enrichir le site à un rythme plus soutenu et d’apporter une diversité de sensibilités que l’auteur ne pourrait produire seul.
...
Mythoskolis évoluera progressivement : amélioration de l’ergonomie, ajout de nouvelles entités, extension à d’autres corpus, enrichissement du graphisme et du modèle généalogique.
